...
async function brokerEvents({
  ...
  if (_worker_threads.isMainThread) {
    ...
    const listLocalModels = () => models.getModelSpecs().filter(spec => !spec.isCached && !spec.internal).map(spec => spec.modelName);
