...
const app = require("@module-federation/aegis/lib/auth")(express(), "/microlib");
...
function hasRoutes(k) {
  if(k && k.route && k.route.path) return true;
  return false
}
/**
...
function clearRoutes() {
  app._router.stack = app._router.stack.filter(
      k => !(hasRoutes(k) && k.route.path.startsWith(apiRoot))
