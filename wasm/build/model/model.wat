(module
 ...
 (global $assembly/model/ArrayOfStrings_ID i32 (i32.const 3))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18468))
 ...
 (data (i32.const 1288) "\01\00\00\00\08\00\00\00k\00e\00y\001")
 (data (i32.const 1308) ",")
 (data (i32.const 1320) "\01\00\00\00\0e\00\00\00d\00e\00f\00a\00u\00l\00t")
 (data (i32.const 1356) "\1c")
 (data (i32.const 1368) "\01\00\00\00\08\00\00\00k\00e\00y\002")
 (data (i32.const 1388) ",")
 ...
 (data (i32.const 1784) "\01\00\00\00\08\00\00\00k\00e\00y\003")
 (data (i32.const 1804) "<")
 (data (i32.const 1816) "\01\00\00\00\1e\00\00\00a\00l\00w\00a\00y\00s\00T\00h\00i\00s\00V\00a\00l\00u\00e")
 (data (i32.const 1868) "\1c")
 (data (i32.const 1884) "\08\00\00\00\00\07\00\00 \07")
 (data (i32.const 1900) "<")
 ...
 (data (i32.const 2032) "\06\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 2060) "\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00\02\t")
 (export "ArrayOfStrings_ID" (global $assembly/model/ArrayOfStrings_ID))
 ...
 (export "modelFactory" (func $export:assembly/model/modelFactory))
 ...
 (func $assembly/model/modelFactory (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/model/modelFactory (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/model/modelFactory
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
