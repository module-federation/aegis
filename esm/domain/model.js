...
var _makePorts = _interopRequireDefault(require("./make-ports"));
var _makeRelations = _interopRequireDefault(require("./make-relations"));
var _undo = _interopRequireDefault(require("./undo"));
var _compose = _interopRequireDefault(require("./util/compose"));
var asyncContext = _interopRequireWildcard(require("./util/async-context"));
...
const Model = (() => {
  ...
  const defaultOnDelete = model => (0, _mixins.withTimestamp)('deleteTime')(model);
  ...
  function rehydrate(clonedModel, model) {
    return model.prototype ? Object.setPrototypeOf(clonedModel, model.prototype) : clonedModel;
  }
  ...
  function make(modelInfo) {
    ...
    return {
      // User mixins
      ...(0, _compose.default)(...mixins)(model),
      // Generate functions to fetch related models
      ...(0, _makeRelations.default)(relations, datasource, broker),
      // Generate port functions to handle domain I/O
      ...(0, _makePorts.default)(ports, dependencies, broker, datasource),
      // Remember port calls
      [PORTFLOW]: [],
      // model class name
      [MODELNAME]: modelName,
      ...
      async update(changes, runValidation = true) {
        ...
        const mergedModel = runValidation ? this[VALIDATE](changes, eventMask.update) : {
          ...this,
          ...changes
        };
       ...
       */
      equals(model) {
        return model && (model.id || model.getId) && (model.id === this[ID] || model.getId() === this[ID]);
      },
      getContext(name) {
      ...
      fetchRelatedDomainService(modelName) {
        ...
        if (require('.').default.getModelSpec(upperName).domain === this[DOMAIN] || Object.values(relations).find(v => v.modelName.toUpperCase() === upperName)) {
      ...
      getDataSource() {
        ...
        return datasource.factory.getRestrictedDataSource(this[MODELNAME], this[DOMAIN]);
      }
    };
  }
   ...
   */
  const makeModel = (0, _pipe.default)(Model, (0, _mixins.withTimestamp)(CREATETIME), (0, _mixins.withSerializers)((0, _mixins.fromSymbol)(keyMap), (0, _mixins.fromTimestamp)(['createTime', 'updateTime'])), (0, _mixins.withDeserializers)((0, _mixins.toSymbol)(keyMap)), validate(eventMask.create), Object.freeze);

  /**
   * Recreate model from deserialized object
   */
  const loadModel = (0, _pipe.default)(make, (0, _mixins.withSerializers)((0, _mixins.fromSymbol)(keyMap), (0, _mixins.fromTimestamp)(['createTime', 'updateTime'])), (0, _mixins.withDeserializers)((0, _mixins.toSymbol)(keyMap)), validate(eventMask.onload), Object.freeze);
